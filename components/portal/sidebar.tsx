...
import { Home, Users, Store, Image, Calendar, LogOut, Menu, X, BookOpen, UserPlus, ListVideo, Radio, LayoutTemplate } from 'lucide-react'
...
const navigation = [
    ...
    { name: 'Streams', href: '/app/streams', icon: Radio },
    { name: 'Menus', href: '/app/menus', icon: LayoutTemplate },
