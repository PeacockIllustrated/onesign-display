        ...
        <div className="flex flex-col items-center">
            <style>{`
                ...
                @keyframes heroGlowPulse {
                    0%, 100% { filter: drop-shadow(0 0 8px rgba(149,218,248,0.4)) drop-shadow(0 0 30px rgba(36,84,91,0.5)); }
                    50% { filter: drop-shadow(0 0 20px rgba(149,218,248,0.7)) drop-shadow(0 0 60px rgba(36,84,91,0.8)); }
                }
                @keyframes heroTextGlow {
                    0%, 100% { filter: drop-shadow(0 0 4px rgba(149,218,248,0.3)) drop-shadow(0 0 16px rgba(36,84,91,0.4)); }
                    50% { filter: drop-shadow(0 0 10px rgba(149,218,248,0.5)) drop-shadow(0 0 30px rgba(36,84,91,0.6)); }
                }
            `}</style>
                ...
                >
                    <defs>
                        <filter id="hero-icon-glow">
                            ...
                            <feFlood floodColor="#95daf8" floodOpacity="0.8" />
                    ...
                    <path
                        ...
                        style={{
                            animation: 'heroDrawPath 1.5s cubic-bezier(0.4, 0, 0.2, 1) forwards',
                        }}
                    />
                    <path
            ...
            <div
                style={{
                    marginTop: 8,
                    animation: iconDone ? 'heroTextGlow 3s ease-in-out infinite 0.5s' : 'none',
                    filter: iconDone ? 'drop-shadow(0 0 6px rgba(149,218,248,0.3)) drop-shadow(0 0 20px rgba(36,84,91,0.4))' : 'none',
                ...
                >
                    ...
                    {DISPLAY_LETTERS.map((d, i) => (
                        <path
                            ...
                            style={iconDone ? {
                                animation: `heroDrawPath 0.6s cubic-bezier(0.4, 0, 0.2, 1) ${i * 0.1}s both`,
                            } : {
                                strokeDashoffset: 1,
                            }}
                        />
